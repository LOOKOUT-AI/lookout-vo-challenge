...
The initial plan contains 75 training and 20 validation clips. Final selection and
RGB/thermal coverage will be specified in the published manifest. A smaller sample
may be released first so participants can test their setup early.
